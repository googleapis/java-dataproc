# Google Cloud Dataproc Client for Java

Java idiomatic client for [Cloud Dataproc][product-docs].
...
You will need a [Google Cloud Platform Console][developer-console] project with the Cloud Dataproc [API enabled][enable-api].
...
## About Cloud Dataproc


[Cloud Dataproc][product-docs] manages Hadoop-based clusters and jobs on Google Cloud Platform.

See the [Cloud Dataproc client library docs][javadocs] to learn how to
use this Cloud Dataproc Client Library.
...
Cloud Dataproc uses gRPC for the transport layer.
...
[javadocs]: https://googleapis.dev/java/google-cloud-dataproc/latest/index.html
